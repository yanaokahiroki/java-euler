...
public class MyLibrary {
  ...
  /**
   * 2つの整数a, bの最大公約数(Greatest Common Divisor, G.C.D)
   * a, bを割り切ることができる最大の数(約数)
   *
   * @param a 整数
   * @param b 整数
   * @return 最大公約数
  ...
  /**
   * 2つの整数a, bの最小公倍数(Least Common Multiple, L.C.M)
   * a, bで共通の倍数の内最も小さい数
   *
   * 以下の関係式よりLCMについて解く
   * 最大公約数G.C.Mと最小公倍数L.C.Mの関係
   * GCM(a, b) * LCM(a, b) = a * b
   *
   * @param a 整数
   * @param b 整数
